    ...
    <form method="POST">
        ...
        <div class="form-group" id="private_data_container">
            ...
            <div>
                ...
                <input type="text" placeholder="127.0.0.1" id="domain" name="domain" />
            </div>
            ...
            <div>
                ...
                <input type="text" placeholder="8080..." id="port" name="port" />
            </div>
    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <div>
                <label for="delivery_type">Delivery Type</label>
                <select name="delivery_type" id="delivery_type">
                    <option value="instant" selected>Real</option>
                    <option value="preorder">Edited</option>
                </select>
            </div>

...
">
    ...
    {{-- @if ($order->public->account_type)
        ...
        <input type="text" name="product_type" value=" {{ $order->public->account_type }}" disabled>
    @endif --}}
    ...
    {{-- @if ($order->private->ip)
    <label for="nickname"> Product Ip : </label>
    <input type="text" name="nickname" value=" {{ $order->private->ip }}" disabled>
@endif --}}
